// Copy of Unity "Hidden/Handles Circular Arc" shader
Shader "Hidden/Cozy/Line Unlit"
{
    CGINCLUDE
    ...
    float _HandleZOffset;
    float _HandleOccludedAlpha;
    ...
    Properties
    {
        ...
        _HandleZOffset ("_HandleZOffset", Float) = 0.01
        _HandleOccludedAlpha ("_HandleOccludedAlpha", Float) = 0.05
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (uint vid : SV_VertexID)
            {
                ...
                v2f o = VertexTail(vertex);
                o.vertex.z += _HandleZOffset;
                return o;
            }
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                if (_UseGUIClip)
                    col.a *= tex2D(_GUIClipTexture, i.clipUV).a;
                return col * half4(1,1,1,_HandleOccludedAlpha);
            }
            ENDCG
        }
    }
